    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            filtered = Object.keys(data).filter(function (k) {
              return data[k] != null;
            }).reduce(function (a, k) {
              return _objectSpread(_objectSpread({}, a), {}, _defineProperty({}, k, data[k]));
            }, {});
            _context.next = 4;
...
exports.deleteRelease = exports.editRelease = exports.addRelease = void 0;
...
var addRelease = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(data) {
    var filtered, res;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
...
var deleteRelease = /*#__PURE__*/function () {
      ...
      while (1) {
        switch (_context3.prev = _context3.next) {
          ...
          case 3:
            ...
            if (res.status === 204) {
              (0, _alerts.showAlert)('success', 'Release Deleted!');
              window.setTimeout(function () {
                location.reload();
              }, 1500);
            }
  ...
  return function deleteRelease(_x4) {
...
if (addMovieForm) {
  addMovieForm.addEventListener('submit', function (e) {
    ...
    var releaseDate = document.getElementById('release-date').value != '' ? document.getElementById('release-date').value : undefined;
    var ratingsAverage = document.getElementById('ratings-average').value != '' ? document.getElementById('ratings-average').value * 1 : undefined;
    var ratingsQuantity = document.getElementById('ratings-quantity').value != '' ? document.getElementById('ratings-quantity').value * 1 : undefined;
    var geners = document.getElementById('geners').value.replaceAll(' ', '').split(',');
    var duration = document.getElementById('duration').value != '' ? document.getElementById('duration').value * 1 : undefined;
    var plot = document.getElementById('plot').value.trim() != '' ? document.getElementById('plot').value.trim() : undefined;
    var mpaa = document.getElementById('mpaa').value.trim() != '' ? document.getElementById('mpaa').value.trim() : undefined;
    var poster = document.getElementById('poster').value.trim() != '' ? document.getElementById('poster').value.trim() : undefined;
    (0, _movies.addMovie)({
      status: status,
      title: title,
      imdbLink: imdbLink,
...
if (addReleaseForm) {
  addReleaseForm.addEventListener('submit', function (e) {
    ...
    var sizeByte = document.getElementById('release-size').value != '' ? document.getElementById('release-size').value * 1 : undefined;
    ...
    var bitrate = document.getElementById('release-bitrate').value != '' ? document.getElementById('release-bitrate').value * 1 : undefined;
...
if (videoStreamsTable) {
  var addStream = document.getElementById('video-add-stream');
  addStream.addEventListener('click', function (e) {
    e.preventDefault();
    var tbodyRowCount = videoStreamsTable.tBodies[0].rows.length;
...
if (audioStreamsTable) {
  var _addStream = document.getElementById('audio-add-stream');

  _addStream.addEventListener('click', function (e) {
    e.preventDefault();
    var tbodyRowCount = audioStreamsTable.tBodies[0].rows.length;
...
function getVideos(videoTable) {
  ...
  for (var i = 0, row; row = videoTable.tBodies[0].rows[i]; i++) {
    var video = getVideoStreamParams(row);
...
function getAudios(audioTable) {
  ...
  for (var i = 0, row; row = audioTable.tBodies[0].rows[i]; i++) {
    var audio = getAudioStreamParams(row);
